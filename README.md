...
| v1.1 | ✅ | **浏览器侧边栏 Agent**：Chrome/Edge MV3 插件 + Native Messaging 宿主 (LocalBridge)，聊天读写当前网页。CLI 保留为共享后端。插件在独立的 [`extension` 分支](https://github.com/CrisXie4/ModelBridge/tree/extension/extension) 维护 |
